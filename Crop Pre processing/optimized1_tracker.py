...
@profile
def mainfunn(img_raw_Color,BLUR,mThres,e_low,e_high,e_iter,cntrst,dil,bg_blur):
    ...
    for contour in contours:
      ...
      if area>800:
        ...
        #gp=10
        cropped= cropp(img_raw_Color, a, b, w, h, 1, 10)
...
class CrowVision(Node):
  ...
  def input_callback(self, msg, topic):
    ...
    crop = mainfunn(img_raw_Color,BLUR,mThres,e_low,e_high,e_iter,cntrst,dil,bg_blur)
